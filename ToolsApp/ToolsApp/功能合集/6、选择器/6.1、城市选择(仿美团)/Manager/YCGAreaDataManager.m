...
@interface YCGAreaDataManager()
@property (nonatomic, strong) FMDatabase *db;
@end

@implementation YCGAreaDataManager

+ (instancetype)shareManager {
    static YCGAreaDataManager *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        
        instance = [[YCGAreaDataManager alloc] init];
    });
    return instance;
}
