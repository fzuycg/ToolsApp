...
- (UIButton *)cancelButton {
    if (!_cancelButton) {
        _cancelButton = [[UIButton alloc] initWithFrame:CGRectMake(0, StatusBar_HEIGHT, 60, NavigationBar_HEIGHT)];
...
- (UIButton *)completeButton {
    if (!_completeButton) {
        _completeButton = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 60, StatusBar_HEIGHT, 60, NavigationBar_HEIGHT)];
...
- (UILabel *)titleLabel {
    if (!_titleLabel) {
        _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, StatusBar_HEIGHT, (self.frame.size.width-120), NavigationBar_HEIGHT)];
