...
//MARK:JmoVxia---播放
- (void)playVideo{
    if (self.BeginBlock && self.url == nil) {
        self.BeginBlock();
    }
...
- (void)beginButton:(BeginButtonBolck)beginButton {
    self.BeginBlock = beginButton;
}
...
//        make.edges.mas_equalTo(self);
    ...
    [self.playerLayerView mas_makeConstraints:^(MASConstraintMaker *make) {
        make.edges.mas_equalTo(_maskView);
//        make.top.mas_equalTo(self);
